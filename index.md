...
“TimeCnvas”（以下简称“本应用”）尊重用户隐私，致力于保护用户的个人信息。以下的隐私政策解释了本应用如何处理用户信息。
...
“TimeCnvas”（以下簡稱“本應用”）尊重用戶隱私，致力於保護用戶的個人信息。以下的隱私政策解釋了本應用如何處理用戶信息。
...
"TimeCnvas"(이하 "본 앱")은 사용자의 개인정보를 존중하며 보호하기 위해 노력하고 있습니다. 다음의 개인정보 처리 방침은 본 앱이 사용자의 정보를 어떻게 처리하는지 설명합니다.
